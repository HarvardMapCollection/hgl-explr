...
jsons_data = pd.DataFrame(columns=['layerid','title', 'description', 'layertype', 'creator', 'format', 'date', 'place', 'subject', 'bbox'])
...
for index, js in enumerate(json_files):
    with open(os.path.join(path_to_json, js)) as json_file:
        ...
        jsons_data.loc[index] = [layerid, title, description, layertype, creator, format, date, place, subject, bbox]
